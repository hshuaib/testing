class CreateCountries < ActiveRecord::Migration
  def change
    ...
    Country.reset_column_information
        ...
        Country.create( :name => 'The Democratic Republic of Congo' )
        ...
        Country.create( :name => 'Islamic Republic of Iran' )
        ...
        Country.create( :name => 'Democratic People\'s Republic of Korea' )
        Country.create( :name => 'Republic of Korea' )
        ...
        Country.create( :name => 'The Former Yugoslav Republic of Macedonia' )
        ...
        Country.create( :name => 'Federated States of Micronesia' )
        Country.create( :name => 'Republic of Moldova' )
        ...
        Country.create( :name => 'United Republic of Tanzania' )
